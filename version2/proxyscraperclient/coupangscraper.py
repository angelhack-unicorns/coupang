...
def main():
  parser = argparse.ArgumentParser(description="Coupang Scraper")
  parser.add_argument("search_item", type=str, help="The item to search for on coupang")
  args = parser.parse_args()
  search_item = args.search_item
  coupang_scraper = CoupangScraper()
  image_urls = coupang_scraper.make_request(search_item)
  image_urls_json = json.dumps(image_urls, indent=2)
